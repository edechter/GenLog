...
- takes the AWS keys from the current environment (those are located
  in my .profile), so that I can put the scripts on github and not
  have to publish my secret AWS keys.
